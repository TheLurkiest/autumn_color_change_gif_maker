...
#...     s1=s1[(s1.find('/') +1):]
    ...
    for frame_elem in r1:
        ...
        if(p_type_choice == 'e'):
            ...
            # we want to include in our selection of RED-NESS number values, any which have a total RED-NESS value which EXCEEDS the GREEN-NESS there by AT LEAST 11.
            a01_min = b2[:,:,0] > b2[:,:,1] + min_bond_len_rg
            a01_max = b2[:,:,0] < b2[:,:,1] + max_bond_len_rg

            a12_min = b2[:,:,1] > b2[:,:,2] + min_bond_len_gb
            a12_max = b2[:,:,1] > b2[:,:,2] + max_bond_len_gb
            ...
            booling2 = a01_min & a01_max & a12_min & a12_max & a_max2 & a_min2 & a_max0 & a_min0 & a_max1 & a_min1
